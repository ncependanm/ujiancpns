...
class registrasi extends CI_Controller
{
    ...
    function index()
    {
		...
		$this->template->load('tema', 'registrasi', $data);
    }
	...
	function save()
	{
		...
		$message = 'Dear User,<br /><br />
					...
					'. base_url() .'cpns/daftar/verify/' . md5($email) . '<br /><br /><br />
					Thanks<br />
					Mydomain Team';
		$hsl = $this->mcrud->cekEmail($email);
		if($hsl <= 0){
		...
		$upload = '';
			...
			echo json_encode(array("status" => FALSE, "msg" => "Email Sudah Terdaftar"));
		}
	}
	...
	{					
		...
		$message = 'Dear User,<br /><br />
					Please click on the below activation link to verify your email address.<br /><br /> 
					'. base_url() .'registrasi/verify/' . md5($user_email) . '<br /><br /><br />
					Thanks<br />
					Mydomain Team';
		// Cek email terdaftar
