        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading" style="color: #FFF">Hasil Tes</h2>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark col-md-12">
										<a href="<?=base_url()?>" class="btn btn-info btn-circle" >Selesai</a>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
							</div>
                                    ...
                                    <table class="table table-hover">
                                            <tbody>
                                                <tr>
                                                    <td>Status</td>
                                                    <td class="text-center">
														<label class="btn btn-transparent blue btn-outline btn-circle btn-sm active" ><?=$status?></label>
													</td>
                                                </tr>
													<?php 
													if($nilaiTWK >= $nilaiTWKBatas){ ?>
                                                <tr class="success">
                                                    <td>
														Anda sudah melewati ambang batas sebesar
													<?php } else { ?>
                                                <tr class="warning">
                                                    <td>
														Anda belum melewati ambang batas
													<?php } ?>
													</td>
                                                    <td class="text-center">
														<label class="btn btn-transparent blue btn-outline btn-circle btn-sm active" ><?=$nilaiTWK-$nilaiTWKBatas?></label>
													</td>
                                                </tr>
													<?php 
													if($nilaiTIU >= $nilaiTIUBatas){ ?>
                                                <tr class="success">
                                                    <td>
														Anda sudah melewati ambang batas sebesar
													<?php } else { ?>
                                                <tr class="warning">
                                                    ...
                                                    <td class="text-center">
														<label class="btn btn-transparent blue btn-outline btn-circle btn-sm active" ><?=$nilaiTIU-$nilaiTIUBatas?></label>
													</td>
                                                </tr>
													<?php 
													if($nilaiTKP >= $nilaiTKPBatas){ ?>
                                                <tr class="success">
                                                    <td>
														Anda sudah melewati ambang batas sebesar
													<?php } else { ?>
                                                <tr class="warning">
                                                    ...
                                                    <td class="text-center">
														<label class="btn btn-transparent blue btn-outline btn-circle btn-sm active" ><?=$nilaiTKP-$nilaiTKPBatas?></label>
													</td>
                                                </tr>
												</tbody>
                                        </table>
