...
<html lang="en">
	...
	function save()
	{
		...
		$('#btnSave').attr('disabled',true); //set button disable 
                    ...
                    var file_tgl_lahir = $('[name="user_tgl_lahir"]').val();
                    ...
                    $.ajax({
                        url: "<?php echo site_url('registrasi/upload_file')?>", // point to server-side controller method
                                ...
                                <div class="portlet-title">
									...
									<form id="form" class="form-horizontal" autocomplete="off">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2">Foto
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
